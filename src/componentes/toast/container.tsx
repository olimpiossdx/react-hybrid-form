  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        {toast.title && (
            <h4 className={`font-bold text-gray-900 dark:text-white mb-1 ${isLarge ? 'text-lg' : 'text-sm'}`}>
                {toast.title}
            </h4>
        )}
        <p className={`text-gray-600 dark:text-gray-300 leading-relaxed ${isLarge ? 'text-base' : 'text-sm'}`}>
            {toast.message}
        </p>
