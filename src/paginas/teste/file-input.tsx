...
const FileExample = () => {
  const MOCK_SERVER_FILES = [{ id: 10, name: "contrato_antigo.pdf", url: "#", size: 102400 }, { id: 11, name: "especificacao_tecnica.docx", url: "#", size: 204800 }];
  ...
  const onSubmit = (data: any) => {
    ...
    showModal({
      ...
      size: 'lg',
      content: (<div className="bg-gray-100 dark:bg-black p-4 rounded border border-gray-200 dark:border-gray-800">
  ...
  return (<div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-5xl mx-auto transition-colors">
