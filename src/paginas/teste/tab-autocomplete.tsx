...
const AsyncAutocompleteExample = () => {
    ...
    showModal({
      ...
      content: (
        <div className="space-y-2">
          <p className="text-sm text-gray-600 dark:text-gray-400">Dados enviados com sucesso:</p>
  ...
  const fetchLideres = async (query: string, pageNum: number, isNewSearch: boolean) => {
    ...
    try {
      ...
      if (shouldFail) {
        throw new Error('Simulação: Falha na conexão.');
      }
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto transition-colors">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 pb-6 border-b border-gray-100 dark:border-gray-700 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Validação de Async, Portal e Estados.</p>
        </div>
      ...
      <form {...formProps} className="space-y-6">
        <div>
          <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Nome da Equipe *</label>
          <input
            type="text"
            name="nome_equipe"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1 ml-1">* Personagens "Dead" são exibidos desabilitados.</p>
          </div>
        ...
        <div className="border-t border-gray-100 dark:border-gray-700 pt-6 mt-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Testes de Robustez</h3>
            <button
              type="button"
      ...
      {showTestModal && (
        <div
          ...
          <div
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Teste de Portal</h3>
            <p className="text-sm text-gray-500 mb-4">O Autocomplete deve "vazar" o container abaixo.</p>
            ...
            <div className="border border-red-300 dark:border-red-900/50 p-4 rounded bg-gray-50 dark:bg-gray-900 overflow-hidden relative h-40 mb-4 ring-1 ring-red-200 dark:ring-red-900/30">
              <p className="text-[10px] text-red-500 dark:text-red-400 mb-2 font-mono">style="overflow: hidden"</p>
