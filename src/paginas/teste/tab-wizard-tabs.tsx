...
const TabWizardTabsExample = () => {
  ...
  const { formProps, validateScope, setValidators } = useForm({ id: "wizard-form", onSubmit });
  ...
  return (<div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto transition-colors">
