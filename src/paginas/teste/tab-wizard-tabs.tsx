...
import { User, MapPin, CheckCircle, ShieldCheck } from 'lucide-react';
    ...
    showModal({
      ...
      content: (
        <div className="space-y-3">
          ...
          <pre className="text-xs bg-gray-100 dark:bg-black p-4 text-green-600 dark:text-green-400 rounded border border-gray-200 dark:border-gray-700 overflow-auto">
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto transition-colors">
      <div className="mb-6 border-b border-gray-100 dark:border-gray-700 pb-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Tente avançar sem preencher os campos. O sistema bloqueia a navegação.
        </p>
      </div>
        ...
        <Tabs.Root defaultValue="step1" beforeChange={handleBeforeChange} className="flex-1 flex flex-col">
          ...
          <div className="flex-1 relative">
            ...
            <Tabs.Content value="step3" className="space-y-6 py-8 text-center animate-in zoom-in-95 fade-in">
              ...
              <label className="flex items-center justify-center gap-2 cursor-pointer text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
                <input type="checkbox" name="termos" className="rounded border-gray-300 dark:border-gray-600 text-cyan-600 focus:ring-cyan-500" data-validation="termos" />
                Li e aceito os termos de uso
              </label>

              <div className="pt-4">
                <button type="submit" className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold shadow-lg transition-transform active:scale-95 w-full sm:w-auto">
                  Finalizar Cadastro
                </button>
              </div>
            </Tabs.Content>
