  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {stacks.map((tech) => (
          <label key={tech.id} className="flex items-center gap-2.5 p-2 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 cursor-pointer hover:border-cyan-500 dark:hover:border-cyan-500 transition-all text-gray-700 dark:text-gray-300 hover:text-cyan-700 dark:hover:text-cyan-300 shadow-sm">
            <input 
                type="checkbox" 
                name="conhecimentos" 
                value={tech.id} 
