...
const ValidationFeedbackExample: React.FC = () => {
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-md mx-auto transition-colors">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Teste de UX: Digite errado, saia (Blur). O feedback visual se adapta ao tema.
        </p>
      </div>
      ...
      <form {...formProps} noValidate>
        <div className="mb-6">
          ...
          <div className="relative">
            <input type="email" name="email" className="form-input pl-10" placeholder="seu@email.com" data-validation="validarEmail" />
        ...
        <div className="mb-8">
          ...
          <div className="relative">
            <input type="password" name="senha" className="form-input pl-10" placeholder="••••••" data-validation="validarSenha" />
