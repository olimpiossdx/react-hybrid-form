...
const FINANCIAL_PRESETS: DatePreset[] = [
    { label: '1º Semestre', getValue: () => [createDate(getToday().getFullYear(), 0, 1), createDate(getToday().getFullYear(), 5, 30)] },
    { label: '2º Semestre', getValue: () => [createDate(getToday().getFullYear(), 6, 1), createDate(getToday().getFullYear(), 11, 31)] },
    { label: 'Ano Fiscal Anterior', getValue: () => [createDate(getToday().getFullYear() - 1, 0, 1), createDate(getToday().getFullYear() - 1, 11, 31)] }
];
...
const DateRangeExample: React.FC = () => {
    ...
    const handleSimulateEdit = () => {
        ...
        resetSection("", {
            ...
            size_sm_start: "2024-01-01", size_sm_end: "2024-01-15",
            mobile_start: "", mobile_end: "",
            restricted_start: toISODate(today), restricted_end: toISODate(addDays(today, 5)),
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-gray-100 dark:border-gray-700 gap-4">
                ...
                <div className="flex gap-2">
                    <button onClick={handleSimulateEdit} type="button" className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-200 rounded border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors">
                        <Download size={14} /> Simular Edição
                    </button>
                    <button onClick={handleReset} type="button" className="flex items-center gap-2 px-3 py-1.5 text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded border border-gray-200 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
            ...
            <form {...formProps} className="space-y-12">
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-cyan-500/50 transition-colors">
                            <div className="mb-4">
                                <h4 className="text-gray-900 dark:text-white font-bold text-sm">1. Enterprise (Dual View)</h4>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Exibe 2 meses lado a lado. Ideal para telas largas.</p>
                            </div>
                            <DateRangePicker 
                                startDateName="enterprise_start" endDateName="enterprise_end" 
                        ...
                        <div className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-lg border border-gray-200 dark:border-gray-700 space-y-6">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Props <code>size="sm" | "md" | "lg"</code></p>
                                
                                <div className="space-y-4">
                                    <DateRangePicker 
                                        startDateName="size_sm_start" endDateName="size_sm_end" 
                                        label="Small (Filtros densos)" 
                                        size="sm"
                                        months={1} showPresets={false}
                                    />
                                    <DateRangePicker 
                                        startDateName="size_lg_start" endDateName="size_lg_end" 
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-purple-500/50 transition-colors max-w-sm">
                        ...
                        <DateRangePicker 
                            startDateName="mobile_start" endDateName="mobile_end" 
                            label="Data" 
                            months={1} showPresets={false} 
                            matchInputWidth 
                        />
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-gray-50 dark:bg-gray-900/30 p-4 rounded border border-gray-200 dark:border-gray-800">
                            <h4 className="text-gray-700 dark:text-gray-300 font-bold text-xs mb-2">Restrito (Futuro + 60d)</h4>
                            <DateRangePicker 
                                startDateName="restricted_start" endDateName="restricted_end" 
                                label="Agendamento" 
                        ...
                        <div className="bg-gray-50 dark:bg-gray-900/30 p-4 rounded border border-gray-200 dark:border-gray-800">
                            <h4 className="text-gray-700 dark:text-gray-300 font-bold text-xs mb-2">Apenas Dias Úteis</h4>
                            <DateRangePicker 
                                startDateName="business_start" endDateName="business_end" 
                        ...
                        <div className="bg-gray-50 dark:bg-gray-900/30 p-4 rounded border border-gray-200 dark:border-gray-800">
                            <h4 className="text-gray-700 dark:text-gray-300 font-bold text-xs mb-2">Presets Customizados</h4>
                            <DateRangePicker 
                                startDateName="fiscal_start" endDateName="fiscal_end" 
                                label="Ano Fiscal" 
                ...
                <section className="space-y-6 pt-8 mt-12 border-t-2 border-dashed border-gray-200 dark:border-gray-800">
                    ...
                    <div className="flex justify-between items-end h-32">
                        <div className="w-64">
                            <DateRangePicker 
                                startDateName="edge_left_start" endDateName="edge_left_end" 
                                label="Borda Inferior (Abre CIMA)" 
                            />
                        </div>
                        <div className="w-64 text-right">
                            <DateRangePicker 
                                startDateName="edge_right_start" endDateName="edge_right_end" 
