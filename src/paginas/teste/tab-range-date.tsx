...
import { Calendar, Download, Layout, Maximize2, MousePointer2, RotateCcw, ShieldAlert, Smartphone } from 'lucide-react';
...
import { addDays, createDate, getToday, toISODate } from '../../utils/date';
    ...
    showModal({
      ...
      content: (
        <div className="space-y-2">
          <p className="text-sm text-gray-600 dark:text-gray-400">Dados brutos (ISO 8601) enviados pelo formulário:</p>
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-gray-100 dark:border-gray-700 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Validação de Layouts, Regras de Negócio e Temas.</p>
        </div>
      ...
      <form {...formProps} className="space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900/30 p-4 rounded border border-gray-200 dark:border-gray-800">
              ...
              <DateRangePicker startDateName="fiscal_start" endDateName="fiscal_end" label="Ano Fiscal" presets={FINANCIAL_PRESETS} />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6 pt-8 mt-12 border-t-2 border-dashed border-gray-200 dark:border-gray-800">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">O Popover inverte a direção se estiver nas bordas da tela.</p>

          <div className="flex justify-between items-end h-32">
            <div className="w-64">
              <DateRangePicker startDateName="edge_left_start" endDateName="edge_left_end" label="Borda Inferior (Abre CIMA)" />
            </div>
