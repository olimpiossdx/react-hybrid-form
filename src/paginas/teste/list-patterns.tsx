...
const QuickList = () => {
  ...
  const { formProps, resetSection, setValidators } = useForm<{ newTask: string;}>({ id: "quick-add-form", onSubmit: handleQuickAdd});
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 h-full flex flex-col transition-colors shadow-lg">
      <div className="flex items-center gap-2 mb-4 border-b border-gray-200 dark:border-gray-700 pb-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Padrão Inline (Enter para adicionar)
          </p>
        </div>
      </div>
      ...
      <form {...formProps} className="flex gap-2 mb-6">
        ...
        <button
          type="submit"
          className="bg-cyan-600 hover:bg-cyan-500 text-white p-2 rounded transition-colors shadow-sm h-[42px]"
        >
          <Plus size={20} />
        </button>
      </form>
...
const DetailedList = () => {
  const { items, add, remove } = useList<IProduct>([
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <span className="text-[10px] text-gray-500 dark:text-gray-400 uppercase block font-bold mb-1">
                  Qtd
                </span>
                <input
                  type="number"
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Comparação entre adição rápida (Inline) e adição rica (Modal) usando a
          mesma arquitetura <code>useList</code> com validação e feedback.
        </p>
      </header>
