...
import useModal from "../../componentes/modal/hook";
...
const TabModal = () => {
  ...
  return (
    <div className="p-6 bg-gray-800 text-white rounded-lg shadow-xl min-h-[600px]">
      ...
      {/* 3. PORTAL: O componente que efetivamente renderiza no body */}
      <Modal {...modalProps} />
    </div>
  );
};
